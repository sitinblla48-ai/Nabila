<div class="row mb-4">
    <div class="col-12">
        ...
        <p class="text-muted">Daftarkan akun pasien baru ke dalam database sistem.</p>
    </div>
</div>
        ...
        <div class="card border-0 shadow-sm card-stat">
            <div class="card-body p-4">
                <div class="d-flex align-items-center mb-4 border-bottom pb-3">
                    ...
                    <div>
                        <h5 class="fw-bold mb-0">Informasi Akun Pasien</h5>
                        <small class="text-muted">Lengkapi semua kolom formulir di bawah ini</small>
                    </div>
                </div>
                ...
                <form action="<?php echo base_url('admin/pasien_create'); ?>" method="POST">
                    
                    <h6 class="fw-bold text-primary mb-3">1. Profil Pribadi</h6>
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <label for="nama_lengkap" class="form-label">Nama Lengkap <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" placeholder="Masukkan nama lengkap" value="<?php echo set_value('nama_lengkap'); ?>" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" id="alamat" name="alamat" rows="3" placeholder="Masukkan alamat lengkap rumah" required><?php echo set_value('alamat'); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="username" name="username" placeholder="Masukkan username unik" value="<?php echo set_value('username'); ?>" required>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="d-flex gap-2 justify-content-end border-top pt-3">
                        ...
                        <button type="submit" class="btn btn-primary px-4 fw-bold">Simpan Akun Pasien</button>
                    </div>
